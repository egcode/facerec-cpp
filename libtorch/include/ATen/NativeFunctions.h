...
CAFFE2_API Tensor copy_real(const Tensor & self);
CAFFE2_API Tensor & copy_real_out(Tensor & out, const Tensor & self);
CAFFE2_API Tensor copy_imag(const Tensor & self);
CAFFE2_API Tensor & copy_imag_out(Tensor & out, const Tensor & self);
...
CAFFE2_API Tensor & bernoulli_tensor_cpu_(Tensor & self, const Tensor & p, c10::optional<Generator> generator=c10::nullopt);
CAFFE2_API Tensor & bernoulli_tensor_cuda_(Tensor & self, const Tensor & p, c10::optional<Generator> generator=c10::nullopt);
CAFFE2_API Tensor & bernoulli_scalar_cpu_(Tensor & self, double p=0.5, c10::optional<Generator> generator=c10::nullopt);
CAFFE2_API Tensor & bernoulli_scalar_cuda_(Tensor & self, double p=0.5, c10::optional<Generator> generator=c10::nullopt);
...
CAFFE2_API Tensor quantized_layer_norm_impl(const Tensor & input, IntArrayRef normalized_shape, const Tensor & weight, const Tensor & bias, double eps, double output_scale, int64_t output_zero_point);
...
CAFFE2_API std::tuple<Tensor,Tensor> _max_cpu(const Tensor & self, int64_t dim, bool keepdim=false);
CAFFE2_API std::tuple<Tensor &,Tensor &> _max_out_cpu(Tensor & max, Tensor & max_indices, const Tensor & self, int64_t dim, bool keepdim=false);
CAFFE2_API std::tuple<Tensor,Tensor> _min_cpu(const Tensor & self, int64_t dim, bool keepdim=false);
CAFFE2_API std::tuple<Tensor &,Tensor &> _min_out_cpu(Tensor & min, Tensor & min_indices, const Tensor & self, int64_t dim, bool keepdim=false);
