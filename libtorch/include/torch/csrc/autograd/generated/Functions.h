...
struct TORCH_API CopyImagBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "CopyImagBackward"; }
  void release_variables() override {
...
struct TORCH_API CopyRealBackward : public TraceableFunction {
  using TraceableFunction::TraceableFunction;
  variable_list apply(variable_list&& grads) override;
  std::string name() const override { return "CopyRealBackward"; }
  void release_variables() override {
